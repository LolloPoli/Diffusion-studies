...
*/
    ...
    TH2D* dRICH_xy = new TH2D("dRICH_xy", "dRICH XY plane distribution | 1.5<Eta<3.5 , P_h>2.5 GeV ; x [cm]; y [cm]", 60, -100, 100, 60, -100, 100);
    ...
    TH1F *DeltaPhi_plot = new TH1F("DeltaPhi", "Phi_h - Phi_s; Phi_h - Phi_s", 50, -TMath::Pi(), TMath::Pi());
    TH1F *DeltaPhi_plot2 = new TH1F("DeltaPhi2", "Phi_h - Phi_s; Phi_h - Phi_s", 50, -TMath::Pi(), TMath::Pi());
    TH1D *DeltaPhi_plot3 = new TH1D("DeltaPhi_Sin", "Phi_h - Phi_s (w: Sin(delta)); Phi_h - Phi_s", 40, -TMath::Pi(), TMath::Pi());
    TH1D *DeltaPhi_xLow  = new TH1D("DeltaPhi_xLow", "Phi_h - Phi_s (w: Sin(delta)) | 0.01 < xb < 0.1; Phi_h - Phi_s", 40, -TMath::Pi(), TMath::Pi());
    TH1D *DeltaPhi_xHigh  = new TH1D("DeltaPhi_xHigh", "Phi_h - Phi_s (w: Sin(delta)) | xb > 0.1; Phi_h - Phi_s", 40, -TMath::Pi(), TMath::Pi());
    ...
    TH2D *pion_Rec_MomVsQ2 = new TH2D("Particle_Rec_RecMomVsQ2", "Mom vs Q^2 | ch. particles | y<0.95; Mom [GeV]; Q^2 [GeV^2]", nben, 2.5, 30, nben, log_bins_Q22.data());
    TH2D *pion_Rec_MomVsEta = new TH2D("Particle_Rec_MomVsEta", "Mom vs Eta | ch. particles | y<0.95; Eta; Mom [GeV]", nben, 1.5, 3.5, nben, 2.5, 30);
    TH2D *pion_Rec_MomVsPhi = new TH2D("Particle_Rec_MomVsTheta", "Mom vs Theta (Polar) | ch. particles | y<0.95; Mom [GeV]; Theta [Deg]", nben, 2.5, 30, nben, 3.5, 25);
    TH2D *pion_Rec_MomVsTheta = new TH2D("Particle_Rec_MomVsPhi", "Mom vs Phi (Azimuth) | ch. particles | y<0.95; Phi [Deg]; Mom [GeV]", nben, -180, 180, nben, 2.5, 30);
    TH2D *pion_Rec_MomVsTheta_HP = new TH2D("Particle_Rec_MomVsTheta_HP", "Mom vs Theta (Polar, Hadron plane) | ch. particles | y<0.95; Mom [GeV]; Theta [Deg]", nben, 2.5, 30, nben, 3.5, 25);
    TH2D *pion_Rec_MomVsPhi_HP = new TH2D("Particle_Rec_MomVsPhi_HP", "Mom vs Phi (Azimuth, Hadron plane) | ch. particles | y<0.95; Phi [Deg]; Mom [GeV]", nben, -180, 180, nben, 2.5, 30);
    TH2D *pion_Rec_PhTvsQ2 = new TH2D("Particle_Rec_PhTVsQ2", "PhT vs Q^2 | ch. particles | y<0.95; PhT [GeV]; Q^2 [GeV^2]", nben, 0, 4, nben, log_bins_Q22.data());
    TH2D *pion_Rec_PhTvsMom = new TH2D("Particle_Rec_PhTvsMom", "PhT Vs Mom | ch. particles | y<0.95; PhT [GeV]; Mom [GeV]",nben, 0, 4, nben, 2.5, 30);
    TH2D *pion_Rec_PhTvsMom2 = new TH2D("Particle_Rec_PhTvsMom2", "PhT Vs Mom | ch. particles | y<0.95; PhT [GeV]; Mom [GeV]",40, 0, 1.4, 40, 2.5, 8);
    TH2D *pion_Rec_PhTvsZ = new TH2D("Particle_Rec_PhTvsZ", "Z vs PhT | ch. particles | y<0.95; z; PhT [GeV]", nben, 0.01, 0.5, nben, 0, 4);
    TH2D *pion_Rec_PhTvsEta = new TH2D("Particle_Rec_PhTVsEta", "PhT vs Eta | ch. particles | y<0.95; Eta; PhT [GeV]", nben, 1.5, 3.5, nben, 0, 4);
    TH2D *pion_Rec_PhTvsPhi = new TH2D("Particle_Rec_PhTvsTheta", "Theta (Polar) vs PhT | ch. particles | y<0.95; PhT [GeV]; Theta [Deg]", nben, 0, 4, nben, 3.5, 25);
    TH2D *pion_Rec_PhTvsTheta = new TH2D("Particle_Rec_PhTvsPhi", "Phi (Azimuth) vs PhT | ch. particles | y<0.95; Phi [Deg]; PhT [GeV]", nben, -180, 180, nben, 0, 4);
    TH2D *pion_Rec_PhTvsTheta_HP = new TH2D("Particle_Rec_PhTvsTheta_HP", "Theta (Polar, Hadron plane) vs PhT | ch. particles | y<0.95; PhT [GeV]; Theta [Deg]", nben, 0, 4, nben, 3.5, 25);
    TH2D *pion_Rec_PhTvsPhi_HP = new TH2D("Particle_Rec_PhTvsPhi_HP", "Phi (Azimuth, Hadron plane) vs PhT | ch. particles | y<0.95; Phi [Deg]; PhT [GeV]", nben, -180, 180, nben, 0, 4);
    TH2D *pion_Rec_ThetaVsPhi = new TH2D("Particle_Rec_PhiVsTheta", "Phi (Azimuth) vs Theta (Polar) | ch. particles | y<0.95; Phi [Deg]; Theta [Deg]", nben, -180, 180, nben, 3.5, 25);
    //TH2D *pion_Rec_ThetaVsPhi2 = new TH2D("Particle_Rec_PhiVsTheta2", "Phi (Azimuth) vs Theta (Polar) | ch. particles | y<0.95; Phi [Deg]; Theta [Deg]", nben, -180, 180, nben, 0, 20);
    TH2D *pion_Rec_Theta_HPVsPhi_HP = new TH2D("Particle_Rec_Phi_HPVsTheta_HP", "Phi_HP (Azimuth) vs Theta_HP (Polar)  | ch. particles | y<0.95; Phi [Deg]; Theta [Deg]", nben, -180, 180, nben, 3.5, 25);
    //TH2D *pion_Rec_Theta_HPVsPhi_HP2 = new TH2D("Particle_Rec_Phi_HPVsTheta_HP2", "Phi_HP (Azimuth) vs Theta_HP (Polar)  | ch. particles | y<0.95; Phi [Deg]; Theta [Deg]", nben, -180, 180, nben, 0, 20);
    TH2D *pion_Rec_ThetaVsTheta_HP = new TH2D("Particle_Rec_ThetaVsTheta_HP", "Theta (Polar) vs Theta (P, Hadron plane) | ch. particles | y<0.95; Theta [Deg]; Theta [Deg]", nben, 3.5, 25, nben, 3.5, 25);
    TH2D *pion_Rec_ThetaVsPhi_HP = new TH2D("Particle_Rec_ThetaVsPhi_HP", "Theta (P, Lab) vs Phi (A, Hadron plane) | ch. particles | y<0.95; Phi_HP [Deg]; Theta [Deg]", nben, -180, 180, nben, 3.5, 25);
    //TH2D *pion_Rec_ThetaVsPhi_HP2 = new TH2D("Particle_Rec_ThetaVsPhi_HP2", "Theta (P, Lab) vs Phi (A, Hadron plane) | ch. particles | y<0.95; Phi_HP [Deg]; Theta [Deg]", nben, -180, 180, nben, 0, 20);
    TH2D *pion_Rec_EtaVsPhi_HP = new TH2D("Particle_Rec_EtaVsPhi_HP", "Eta vs Phi (A, Hadron plane) | ch. particles | y<0.95; Phi [Deg]; Eta", nben, -180, 180, nben, 1.5, 3.5);
    TH2D *pion_Rec_PhiVsPhi_HP = new TH2D("Particle_Rec_PhiVsPhi_HP", "Phi (Azimuth) vs Phi (A, Hadron plane) | ch. particles | y<0.95; Phi_lab [Deg]; Phi_h [Deg]", nben, -180, 180, nben, -180, 180);
    TH2D *pion_Rec_Phi_HPvsPhi_s = new TH2D("Particle_Rec_Phi_HPvsPhi_s", "Phi_h (Hadron plane) vs Phi_s (Spin)  | ch. particles | y<0.95; Phi_h [Deg]; Phi_s [Deg]", nben, -180, 180, nben, -180, 180);
    TH2D *pion_Rec_ZvsQ2 = new TH2D("Particle_Rec_ZvsQ2", "Z vs Q^2 | ch. particles | y<0.95; z ; Q^2 [GeV^2]", nben, 0.01, 0.5, nben, log_bins_Q22.data());
    TH2D *pion_Rec_ZvsMom = new TH2D("Particle_Rec_ZvsMom", "Z vs Mom | ch. particles | y<0.95; z; Mom [GeV]", nben, 0.01, 0.5, nben, 2.5, 30);
    TH2D *pion_Rec_ZvsPhi = new TH2D("Particle_Rec_ZVsTheta", "Z vs Theta (Polar) | ch. particles | y<0.95; z; Theta [Deg]", nben, 0.01, 0.5, nben, 3.5, 25);
    TH2D *pion_Rec_ZvsTheta = new TH2D("Particle_Rec_ZvsPhi", "Z vs Phi (Azimuth) | ch. particles | y<0.95; Phi [Deg]; z", nben, -180, 180, nben, 0.01, 0.5);
    TH2D *pion_Rec_ZvsTheta_HP = new TH2D("Particle_Rec_ZVsTheta_HP", "Z vs Theta (Polar, Hadron plane) | ch. particles | y<0.95; z; Theta [Deg]", nben, 0.01, 0.5, nben, 3.5, 25);
    TH2D *pion_Rec_ZvsPhi_HP = new TH2D("Particle_Rec_ZvsPhi_HP", "Z vs Phi (Azimuth, Hadron plane) | ch. particles | y<0.95; Phi [Deg]; z", nben, -180, 180, nben, 0.01, 0.5);
    TH2D *pion_Rec_P_TvsQ2 = new TH2D("Particle_Rec_P_TvsQ2", "P_T vs Q^2 | ch. particles | y<0.95; P_T [GeV]; Q^2 [GeV^2]", nben, 0, 4, nben, log_bins_Q22.data());
    TH2D *pion_Rec_P_TvsXb = new TH2D("Particle_Rec_P_TvsXb", "Xb vs P_T | ch. particles | y<0.95; xB; PhT [GeV]", nben, log_bins_xbj2.data(), nben, 0, 4);
    TH2D *pion_Rec_P_TvsMom = new TH2D("Particle_Rec_P_TvsMom", "P_T Vs Mom | ch. particles | y<0.95; P_T [GeV]; Mom [GeV]",nben, 0, 4, nben, 2.5, 30);
    TH2D *pion_Rec_P_TvsMom2 = new TH2D("Particle_Rec_P_TvsMom2", "P_T Vs Mom | ch. particles | y<0.95; P_T [GeV]; Mom [GeV]",nben, 0, 1.4, nben, 2.5, 8);
    TH2D *pion_Rec_P_TvsZ = new TH2D("Particle_Rec_P_TvsZ", "Z vs P_T | ch. particles | y<0.95; z; P_T [GeV]", nben, 0.01, 0.5, nben, 0, 4);
    TH2D *pion_Rec_P_TvsEta = new TH2D("Particle_Rec_P_TVsEta", "P_T vs Eta | ch. particles | y<0.95; Eta; P_T [GeV]", nben, 1.5, 3.5, nben, 0, 4);
    TH2D *pion_Rec_P_TvsPhi = new TH2D("Particle_Rec_P_TvsTheta", "Theta (Polar) vs P_T | ch. particles | y<0.95; P_T [GeV]; Theta [Deg]", nben, 0, 4, nben, 3.5, 25);
    TH2D *pion_Rec_P_TvsTheta = new TH2D("Particle_Rec_P_TvsPhi", "Phi (Azimuth) vs P_T | ch. particles | y<0.95; Phi [Deg]; P_T [GeV]", nben, -180, 180, nben, 0, 4);
    TH2D *pion_Rec_P_TvsTheta_HP = new TH2D("Particle_Rec_P_TvsTheta_HP", "Theta (Polar, Hadron plane) vs P_T | ch. particles | y<0.95; P_T [GeV]; Theta [Deg]", nben, 0, 4, nben, 2.5, 25);
    TH2D *pion_Rec_P_TvsPhi_HP = new TH2D("Particle_Rec_P_TvsPhi_HP", "Phi (Azimuth, Hadron plane) vs P_T | ch. particles | y<0.95; Phi [Deg]; P_T [GeV]", nben, -180, 180, nben, 0, 4);
    TH2D *pion_Rec_Q2vsEta = new TH2D("Particle_Rec_Q2vsEta", "Eta vs Q^2 | ch. particles | y<0.95; Eta ; Q^2 [GeV^2]", nben, 1.5, 3.5, nben, log_bins_Q22.data());
    TH2D *pion_Rec_XbVsMom = new TH2D("Particle_Rec_XbVsMom", "Xb vs Mom | ch. particles | y<0.95; xB; Mom [GeV]", nben, log_bins_xbj2.data(), nben, 2.5, 30);
    TH2D *pion_Rec_XbVsPhT = new TH2D("Particle_Rec_XbVsPhT", "Xb vs PhT | ch. particles | y<0.95; xB; PhT [GeV]", nben, log_bins_xbj2.data(), nben, 0, 4);
    TH2D *pion_Rec_XbVsZ = new TH2D("Particle_Rec_XbVsZ", "Xb vs Z | ch. particles | y<0.95; xB; z", nben, log_bins_xbj2.data(), nben, 0.01, 0.5);
    TH2D *pion_Rec_XbVsEta = new TH2D("Particle_Rec_XbVsEta", "Xb vs Eta | ch. particles | y<0.95; Eta; xB",nben, 1.5, 3.5, nben, log_bins_xbj2.data());
    TH2D *pion_Rec_XbVsPhi = new TH2D("Particle_Rec_XbVsTheta", "Xb vs Theta (Polar) | ch. particles | y<0.95; xB; Theta [Deg]", nben, log_bins_xbj2.data(), nben, 3.5, 25);
    //TH2D *pion_Rec_XbVsPhi2 = new TH2D("Particle_Rec_XbVsTheta2", "Xb vs Theta (Polar) | ch. particles | y<0.95; Theta [Deg]; xB", nben, 2.5, 30, nben, log_bins_xbj2.data());
    TH2D *pion_Rec_XbVsTheta = new TH2D("Particle_Rec_XbvsPhi", "Xb vs Phi (Azimuth) | ch. particles | y<0.95; Phi [Deg]; xB", nben, -180, 180, nben, log_bins_xbj2.data());
    TH2D *pion_Rec_XbVsTheta_HP = new TH2D("Particle_Rec_XbVsTheta_HP", "Xb vs Theta (Polar, Hadron plane) | ch. particles | y<0.95; xB; Theta [Deg];", nben, log_bins_xbj2.data(), nben, 3.5, 25);
    //TH2D *pion_Rec_XbVsTheta_HP2 = new TH2D("Particle_Rec_XbVsTheta_HP2", "Xb vs Theta (Polar, Hadron plane) | ch. particles | y<0.95; Theta [Deg]; xB", nben, 2.5, 30, nben, log_bins_xbj2.data());
    TH2D *pion_Rec_XbVsPhi_HP = new TH2D("Particle_Rec_XbvsPhi_HP", "Xb vs Phi (Azimuth, Hadron plane) | ch. particles | y<0.95; Phi [Deg]; xB", nben, -180, 180, nben, log_bins_xbj2.data());
    TH2D *pion_Rec_XbVsQ2 = new TH2D("Particle_Rec_XbVsQ2", "Xb vs Q^2 | ch. particles | y<0.95; xB; Q^2 [GeV^2]", nben, log_bins_xbj2.data(), nben, log_bins_Q22.data());
    //TH2D *gamma_ThetaVsPhi2 = new TH2D("gamma_PhiVsTheta2", "Phi (Azimuth) vs Theta (Polar) | gamma | y<0.95; Phi [Deg]; Theta [Deg]", nben, -180, 180, nben, 3.5, 25);
    TH2D* dRICH_xy_Rec = new TH2D("dRICH_xy_Rec", "dRICH XY plane distribution | 1.5<Eta<3.5 , P_h>2.5 GeV ; x [cm]; y [cm]", 60, -100, 100, 60, -100, 100);

    //____________________________________________________________________________________________________________________________________________________________________________________________

    TH2D* dRICH_xy_PID = new TH2D("dRICH_xy_PID", "dRICH XY plane distribution | 1.5<Eta<3.5 , P_h>2.5 GeV ; x [cm]; y [cm]", 60, -100, 100, 60, -100, 100);
                          ...
                          if(simuAssoc[j] == i) // Find association index matching the index of the thrown particle we are looking at
                            {
                              ...
                              /*
                              double Polar_gammaRad_Rec = ScatPhoton_Rec.Theta();
                              double Polar_gammaDeg_Rec = Polar_gammaRad_Rec * (180.0/TMath::Pi());
                              double Azimuth_gammaRad_Rec = ScatPhoton_Rec.Phi();
                              double Azimuth_gammaDeg_Rec = Azimuth_gammaRad_Rec * (180.0/TMath::Pi());
                              PolarGammaDeg.push_back(Polar_gammaDeg);
                              PolarGammaRad.push_back(Polar_gammaRad);
                              AzimuthGammaDeg.push_back(Azimuth_gammaDeg);
                              AzimuthGammaRad.push_back(Azimuth_gammaRad);
            ...
            {  
              if(pdg == 211 || pdg == 321 || pdg == 2212)
                { 
                  ...
                  double t = (198 - pion_EpZ) / pion_vZ_Unit;
                  ...
                  if(pionEta >= 1.5 && pionEta <= 3.5){
                        ...
                        if(simuAssoc[j] == i) // Find association index matching the index of the thrown particle we are looking at
                          {
                            ...
                            // aggiunte
                            //TVector3 EndPointVector_Rec(RecEndPointX[recoAssoc[j]],RecEndPointY[recoAssoc[j]],RecEndPointZ[recoAssoc[j]]); // non mi convince ovviamente
                            TVector3 EndPointVector_Rec(EndPointX[simuAssoc[j]],EndPointY[simuAssoc[j]],EndPointZ[simuAssoc[j]]);
                            TVector3 AxPi_Rec = recPionMom.Unit();
                            double pion_vX_Rec = recPionMom.X();
                            double pion_vY_Rec = recPionMom.Y();
                            double pion_vZ_Rec = recPionMom.Z();
                            double pion_vX_Unit_Rec = AxPi_Rec.X();
                            double pion_vY_Unit_Rec = AxPi_Rec.Y();
                            double pion_vZ_Unit_Rec = AxPi_Rec.Z();
                            // PIANO DEL dRICH
                            double pion_EpZ_Rec = EndPointVector_Rec.Z();
                            double t_Rec = (198 - pion_EpZ_Rec) / pion_vZ_Unit_Rec;
                            double x_drich_Rec = EndPointVector_Rec.X() + t_Rec*pion_vX_Unit_Rec;
                            double y_drich_Rec = EndPointVector_Rec.Y() + t_Rec*pion_vY_Unit_Rec;

                            if(recpionEta >= 1.5 && recpionEta <= 3.5){
                              double recpPhi = recPionMom.Theta();
                              double recpTheta = recPionMom.Phi();
                              ...
                              if(y_DA_pion_Rec <= 0.95){
                                if(parentsIndex[i]<=5){
                                  ...
                                  if(z_DA_pion_Rec <= 1){
                                    // mettiamo lo sbattone dell'hadron plane
                                    TVector3 CurrentGammaVector_Rec = GammaVectorSingle_Rec;
                                    TVector3 z_axis_SP_Rec = CurrentGammaVector_Rec.Unit(); // voglio che l'asse z sia lungo la direzione di gamma
                                    double z_axis_z_Rec = z_axis_SP_Rec.Z();
                                    double z_axis_y_Rec = z_axis_SP_Rec.Y();
                                    double z_axis_x_Rec = z_axis_SP_Rec.X();
                                    // per calcolare y mi serve il prodotto vettoriale tra il leptone entrante e gamma
                                    TVector3 CurrentBeamElectronVector_Rec = BeamElectronVectorSingle_Rec;
                                    TVector3 ipsilon_Rec = CurrentGammaVector_Rec.Cross(CurrentBeamElectronVector_Rec);
                                    TVector3 y_axis_SP_Rec = ipsilon_Rec.Unit();
                                    TVector3 x_axis_SP_Rec = y_axis_SP_Rec.Cross(z_axis_SP_Rec);
                                    // BENE ADESSO ABBIAMO I NOSTRI ASSI DEL PIANO DI SCATTERING
                                    double P_T_Rec = recPionMom.Perp(z_axis_SP_Rec); // questo comando mi da il vettore ortogonale a z, quindi il momento trasverso
                                    double Theta_HP_Rad_Rec = recPionMom.Angle(z_axis_SP_Rec); // dovrebbe fornire l'angolo polare del hadron plane
                                    double Theta_HP_Deg_Rec = Theta_HP_Rad_Rec * (180.0/TMath::Pi());
                                    // però vogliamo anche il vettore del momento trasverso
                                    double PdotZ_Rec = recPionMom.Dot(z_axis_SP_Rec); // momento proiettato sull'asse z
                                    double PdotY_Rec = recPionMom.Dot(y_axis_SP_Rec);
                                    double PdotX_Rec = recPionMom.Dot(x_axis_SP_Rec);
                                    TVector3 axis_HP_Rec(PdotX_Rec, PdotY_Rec, PdotZ_Rec);
                                    TVector3 axis_HP_Unit_Rec = axis_HP_Rec.Unit();
                                    double z_Rec = axis_HP_Unit_Rec.Z();
                                    double y_Rec = axis_HP_Unit_Rec.Y();
                                    double x_Rec = axis_HP_Unit_Rec.X();
                                    TVector3 Momentum_Z_Rec = PdotZ_Rec * z_axis_SP_Rec;
                                    TVector3 P_T_Vector_Rec = recPionMom - Momentum_Z_Rec; // ora lo possiamo usare per trovare l'angolo azimutale
                                    TVector3 P_T_axis_Rec = P_T_Vector_Rec.Unit();
                                    double P_T_Vector_x_Rec = P_T_Vector_Rec * x_axis_SP_Rec;
                                    double P_T_Vector_y_Rec = P_T_Vector_Rec * y_axis_SP_Rec; // calcolo il momento trasverso sugli assi x e y
                                    double Phi_HP_Rad_Rec = std::atan2(P_T_Vector_y_Rec, P_T_Vector_x_Rec);
                                    double Phi_HP_Deg_Rec = Phi_HP_Rad_Rec * (180.0/TMath::Pi()); 
                                    // MISURA DI PHI_s
                                    TVector3 termine1_1_Rec = x_axis_SP_Rec.Cross(ProtonSpin);
                                    double termine1_Rec = termine1_1_Rec * z_axis_SP_Rec;
                                    double termine2_Rec = x_axis_SP_Rec.Dot(ProtonSpin);
                                    double Phi_s_Rec = std::atan2(termine1_Rec, termine2_Rec);
                                    double Phi_s_Deg_Rec = Phi_s_Rec * (180/TMath::Pi());
                                    if(mom_pion_Rec >= 2.5){
                                        //xQplane->Fill(xbj_DA_pion, Q2_DA_pion);
                                        //pion_PhT->Fill(PhT_pion);
                                        //pion_PT->Fill(P_T);
                                        pion_Rec_MomVsQ2->Fill(mom_pion_Rec, Q2_DA_pion_Rec);
                                        pion_Rec_MomVsEta->Fill(recpionEta, mom_pion_Rec);
                                        pion_Rec_PhTvsQ2->Fill(PhT_pion_Rec, Q2_DA_pion_Rec);
                                        pion_Rec_PhTvsEta->Fill(recpionEta, PhT_pion_Rec);
                                        pion_Rec_MomVsPhi->Fill(mom_pion_Rec, recpionPhi);
                                        pion_Rec_PhTvsZ->Fill(z_DA_pion_Rec, PhT_pion_Rec);
                                        pion_Rec_MomVsTheta->Fill(recpionTheta, mom_pion_Rec);
                                        pion_Rec_MomVsTheta_HP->Fill(mom_pion_Rec, Theta_HP_Deg_Rec);
                                        pion_Rec_MomVsPhi_HP->Fill(Phi_HP_Deg_Rec, mom_pion_Rec);
                                        pion_Rec_ThetaVsPhi->Fill(recpionTheta,recpionPhi);
                                        //pion_Rec_ThetaVsPhi2->Fill(pionTheta,pionPhi);
                                        pion_Rec_Theta_HPVsPhi_HP->Fill(Phi_HP_Deg_Rec, Theta_HP_Deg_Rec);
                                        //pion_Rec_Theta_HPVsPhi_HP2->Fill(Phi_HP_Deg, Theta_HP_Deg);
                                        pion_Rec_PhTvsPhi->Fill(PhT_pion_Rec, recpionPhi);
                                        pion_Rec_PhTvsTheta->Fill(recpionTheta, PhT_pion_Rec);
                                        pion_Rec_PhTvsPhi_HP->Fill(Phi_HP_Deg_Rec, PhT_pion_Rec);
                                        pion_Rec_PhTvsTheta_HP->Fill(PhT_pion_Rec, Theta_HP_Deg_Rec);
                                        //pion_Rec_MomVsPhiVsTheta->Fill(pionTheta, mom_pion, pionPhi);
                                        pion_Rec_PhTvsMom->Fill(PhT_pion_Rec, mom_pion_Rec);
                                        pion_Rec_PhTvsMom2->Fill(PhT_pion_Rec,mom_pion_Rec);
                                        pion_Rec_ZvsQ2->Fill(z_DA_pion_Rec, Q2_DA_pion_Rec);
                                        pion_Rec_ZvsMom->Fill(z_DA_pion_Rec, mom_pion_Rec);
                                        pion_Rec_ZvsPhi->Fill(z_DA_pion_Rec, recpionPhi);
                                        pion_Rec_ZvsTheta->Fill(recpionTheta, z_DA_pion_Rec);
                                        pion_Rec_ZvsPhi_HP->Fill(Phi_HP_Deg_Rec,z_DA_pion_Rec);
                                        pion_Rec_ZvsTheta_HP->Fill(z_DA_pion_Rec, Theta_HP_Deg_Rec);
                                        pion_Rec_XbVsMom->Fill(xbj_DA_pion_Rec, mom_pion_Rec);
                                        pion_Rec_XbVsPhT->Fill(xbj_DA_pion_Rec, PhT_pion_Rec);
                                        pion_Rec_XbVsZ->Fill(xbj_DA_pion_Rec, z_DA_pion_Rec);
                                        pion_Rec_XbVsPhi->Fill(xbj_DA_pion_Rec, recpionPhi);
                                        //pion_Rec_XbVsPhi2->Fill(recpionPhi, xbj_DA_pion_Rec);
                                        pion_Rec_XbVsTheta->Fill(recpionTheta, xbj_DA_pion_Rec);
                                        pion_Rec_XbVsPhi_HP->Fill(Phi_HP_Deg_Rec, xbj_DA_pion_Rec);
                                        pion_Rec_XbVsTheta_HP->Fill(xbj_DA_pion_Rec, Theta_HP_Deg_Rec);
                                        //pion_Rec_XbVsTheta_HP2->Fill(Theta_HP_Deg_Rec, xbj_DA_pion_Rec);
                                        pion_Rec_XbVsQ2->Fill(xbj_DA_pion_Rec, Q2_DA_pion_Rec);
                                        //pion_Rec_PhTvsZvsXb->Fill(xbj_DA_pion, z_DA_pion, PhT_pion);
                                        pion_Rec_XbVsEta->Fill(recpionEta, xbj_DA_pion_Rec);
                                        //z_axisSP->Fill(z_axis_z, z_axis_x, z_axis_y);
                                        pion_Rec_P_TvsPhi->Fill(P_T_Rec, recpionPhi);
                                        pion_Rec_P_TvsTheta->Fill(recpionTheta, P_T_Rec);
                                        pion_Rec_P_TvsPhi_HP->Fill(Phi_HP_Deg_Rec, P_T_Rec);
                                        pion_Rec_P_TvsTheta_HP->Fill(P_T_Rec, Theta_HP_Deg_Rec);
                                        pion_Rec_P_TvsEta->Fill(recpionEta, P_T_Rec);
                                        pion_Rec_P_TvsMom->Fill(P_T_Rec,mom_pion_Rec);
                                        pion_Rec_P_TvsMom2->Fill(P_T_Rec,mom_pion_Rec);
                                        pion_Rec_P_TvsQ2->Fill(P_T_Rec, Q2_DA_pion_Rec);
                                        pion_Rec_P_TvsZ->Fill(z_DA_pion_Rec, P_T_Rec);
                                        pion_Rec_P_TvsXb->Fill(xbj_DA_pion_Rec, P_T_Rec);
                                        pion_Rec_ThetaVsTheta_HP->Fill(recpionPhi, Theta_HP_Deg_Rec);
                                        pion_Rec_PhiVsPhi_HP->Fill(recpionTheta, Phi_HP_Deg_Rec);
                                        pion_Rec_Q2vsEta->Fill(recpionEta, Q2_DA_pion_Rec);
                                        //axisHP->Fill(z, x, y);
                                        pion_Rec_EtaVsPhi_HP->Fill(Phi_HP_Deg_Rec, recpionEta);
                                        pion_Rec_ThetaVsPhi_HP->Fill(Phi_HP_Deg_Rec, recpionPhi);
                                        pion_Rec_Phi_HPvsPhi_s->Fill(Phi_HP_Deg_Rec, Phi_s_Deg_Rec);
                                        //pion_ThetaVsPhi_HP2->Fill(Phi_HP_Deg, pionPhi);
                                        if(pion_EpZ_Rec >= 190){
                                          dRICH_xy_Rec->Fill(x_drich_Rec, y_drich_Rec);
                                          if(recpdg==pdg){
                                          dRICH_xy_PID->Fill(x_drich_Rec, y_drich_Rec);
                                          }
                                        }
                                    }
                                  }
                    ...
                    float DeltaPhi = Phi_HP_Rad - Phi_s;
                    float DeltaPhi2 = phi_hh_Rad - phi_s22;
