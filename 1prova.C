...
*/
    ...
    // GRAFICI DI ETA
    TH1D *truepionEta = new TH1D("truepionEta","Eta of charged Pions;Eta",80,1.5,3.5);
    TH1D *RecpionEta = new TH1D("RecpionEta","Eta of reconstructed Pions+;Eta",80,1.5,3.5);
    TH1D *truekaonEta = new TH1D("truekaonEta","Eta of charged Kaons;Eta",80,1.5,3.5);
    TH1D *ReckaonEta = new TH1D("ReckaonEta","Eta of reconstructed K+;Eta",80,1.5,3.5);
    TH1D *trueprotonEta = new TH1D("trueprotonEta","Eta of charged Protons;Eta",80,1.5,3.5);
    TH1D *RecprotonEta = new TH1D("RecprotonEta","Eta of reconstructed Protons;Eta",80,1.5,3.5);
    // GRAFICI DI PHI
    ...
    TH2D *pion_MomVsEta_rec = new TH2D("pion_MomVsEta_rec", "Mom vs Eta | pion | y<0.95; Eta; Mom [GeV]", nben, 1.5, 3.5, nben, log_bins_Mom.data());
    TH2D *pion_MomVsPhi_rec = new TH2D("pion_MomVsPhi_rec", "Mom vs Phi (Polar) | pion | y<0.95; Phi [Deg]; Mom [GeV]", nben, 3, 25, nben, log_bins_Mom.data());
    TH2D *pion_PhTvsZ = new TH2D("pion_PhTvsZ", "Z vs PhT | pion | y<0.95; z; PhT [GeV]", nben, log_bins_z2.data(), nben, log_bins_PhT2.data());
    TH2D *pion_PhTvsZ_rec = new TH2D("pion_PhTvsZ_rec", "Z vs PhT | pion | y<0.95; z; PhT [GeV]", nben, log_bins_z2.data(), nben, log_bins_PhT2.data());
    ...
    TH2D *pion_MomVsTheta_rec = new TH2D("pion_MomVsTheta_rec", "Mom vs Theta (Azimuth) | pion | y<0.95; Theta [Deg]; Mom [GeV]", nben, -90, 90, nben, log_bins_Mom.data());
    TH2D *pion_ThetaVsPhi = new TH2D("pion_ThetaVsPhi", "Theta (Azimuth) vs Phi (Polar) | pion | y<0.95; Theta [Deg]; Phi [Deg]", nben, -90, 90, nben, 0, 25);
    TH2D *pion_ThetaVsPhi_rec = new TH2D("pion_ThetaVsPhi_rec", "Theta (Azimuth) vs Phi (Polar) | pion | y<0.95; Theta [Deg]; Phi [deg]", nben, -90, 90, nben, 0, 25);
    TH2D *pion_PhTvsPhi = new TH2D("pion_PhTvsPhi", "Phi (Polar) vs PhT | pion | y<0.95; Phi [Deg]; PhT [GeV]", nben, 3, 25, nben, log_bins_PhT2.data());
    TH2D *pion_PhTvsPhi_rec = new TH2D("pion_PhTvsPhi_rec", "Phi (Polar) vs PhT | pion | y<0.95; Phi [Deg]; PhT [GeV]", nben, 3, 25, nben, log_bins_PhT2.data());
    ...
    TH2D *pion_PhTvsTheta_rec = new TH2D("pion_PhTvsTheta_rec", "Theta (Azimuth) vs PhT | pion | y<0.95; Theta [Deg]; PhT [GeV]", nben, -90, 90, nben, log_bins_PhT2.data());
    TH2D *pion_PhTVsEta = new TH2D("pion_PhTVsEta", "PhRT vs Eta | pion | y<0.95; Eta; PhT [GeV]", nben, 1.5, 3.5, nben, log_bins_PhT2.data());
    TH2D *pion_PhTVsEta_rec = new TH2D("pion_PhTVsEta_rec", "PhT vs Eta | pion | y<0.95; Eta; PhT [GeV]", nben, 1.5, 3.5, nben, log_bins_PhT2.data());
    ...
    TH2D *kaon_MomVsEta_rec = new TH2D("kaon_MomVsEta_rec", "Mom vs Eta | kaon | y<0.95; Eta; Mom [GeV]", nben, 1.5, 3.5, nben, log_bins_Mom.data());
    TH2D *kaon_MomVsPhi_rec = new TH2D("kaon_MomVsPhi_rec", "Mom vs Phi (Polar) | kaon | y<0.95; Phi [Deg]; Mom [GeV]", nben, 3, 25, nben, log_bins_Mom.data());

    TH2D *proton_MomVsEta = new TH2D("proton_MomVsEta", "Mom vs Eta | proton | y<0.95; Eta; Mom [GeV]", nben, 1.5, 3.5, nben, log_bins_Mom.data());
    TH2D *proton_MomVsPhi = new TH2D("proton_MomVsPhi", "Mom vs Phi (Polar) | proton | y<0.95; Phi [Deg]; Mom [GeV]", nben, 3, 25, nben, log_bins_Mom.data());
    ...
    //PROVA DI TH3D
    int nban = 30;
    std::vector<double> log_bins_Mom2 = CreateLogBinning(nban, xmin_mom, xmax_mom);
    ...
    nban, -90, 90, nban, 0, 1, nban, 0, 25);
    pion_MomVsPhiVsTheta->GetYaxis()->Set(nban, log_bins_Mom2.data());
    ...
    TH1D *RealpionEta = new TH1D("RealpionEta", "Real reconstruction of Pions+ in function of Q^2; GeV^2",  80, 1.5, 3.5);
    TH1D *RealkaonEta = new TH1D("RealkaonEta", "Reconstruction of Kaons in function of Q^2; GeV^2",  80, 1.5, 3.5);
    TH1D *RealprotonEta = new TH1D("RealprotonEta", "Production of Protons in function of Q^2; GeV^2",  80, 1.5, 3.5);
    TH1D *RealpionPhi = new TH1D("RealpionPhi", "Real reconstruction of Pions+ in function of Q^2; GeV^2",  80, 0, 25);
    TH1D *RealkaonPhi = new TH1D("RealkaonPhi", "Reconstruction of Kaons in function of Q^2; GeV^2",  80, 0, 25);
    TH1D *RealprotonPhi = new TH1D("RealprotonPhi", "Production of Protons in function of Q^2; GeV^2",  80, 0, 25);
              ...
              if(pdg == 211)
                { 
                  ...
                  if(pionEta > 1.5 && pionEta <= 3.5){
                    ...
                    double pionThetaRad = 0.5*truePionMom.Phi(); // THETA ANGOLO AZIMUTALE 
                        ...
                        if(simuAssoc[j] == i) // Find association index matching the index of the thrown particle we are looking at
                          {
                            ...
                            if(reckaonEta <= 3.5 && reckaonEta >= 1.5){
              ...
              if(pdg == 2212)
                {
                  ...
                  if(protonEta <= 3.5 && protonEta >= 1.5){
                        ...
                        if(simuAssoc[j] == i) // Find association index matching the index of the thrown particle we are looking at
                          {
                            ...
                            if(recprotEta <= 3.5 && recprotEta >= 1.5){
